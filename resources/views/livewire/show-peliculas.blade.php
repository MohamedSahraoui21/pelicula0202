<x-propios.principal>
            ...
            <tbody>
                @foreach ($peliculas as $item)
                    <tr
                        ...
                        <td class="w-4 p-4">
                            <button><i class="fas fa-info text-xl hover:text-4xl text-blue"></i></button>
                        </td>
                        <th scope="row"
    ...
    @else
        <p div class="p-2 rounded-xl shadow-xl text-gray-200 bg-gray-700 font-bold text-small">
            no se encontro ningun pelicula modifique los terminos de busqueda.
        </p>
    @endif
